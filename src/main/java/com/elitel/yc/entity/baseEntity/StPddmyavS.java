...
public class StPddmyavS implements Serializable {
    private String stcd;
    ...
    public BigDecimal getMydavp() {
        return mydavp;
    }

    public void setMydavp(BigDecimal mydavp) {
        this.mydavp = mydavp;
    }
    ...
    public String toString() {
        ...
        sb.append(", mydavp=").append(mydavp);
