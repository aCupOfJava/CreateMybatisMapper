...
public class StPdmmyavS implements Serializable {
    private String stcd;
    ...
    public BigDecimal getMymavp() {
        return mymavp;
    }

    public void setMymavp(BigDecimal mymavp) {
        this.mymavp = mymavp;
    }
    ...
    public String toString() {
        ...
        sb.append(", mymavp=").append(mymavp);
