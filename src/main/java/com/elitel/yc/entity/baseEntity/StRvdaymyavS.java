...
public class StRvdaymyavS implements Serializable {
    private String stcd;
    ...
    private BigDecimal mydavz;

    private BigDecimal mydavq;
    ...
    public BigDecimal getMydavz() {
        return mydavz;
    }

    public void setMydavz(BigDecimal mydavz) {
        this.mydavz = mydavz;
    }

    public BigDecimal getMydavq() {
        return mydavq;
    }

    public void setMydavq(BigDecimal mydavq) {
        this.mydavq = mydavq;
    }
    ...
    public String toString() {
        ...
        sb.append(", mydavz=").append(mydavz);
        sb.append(", mydavq=").append(mydavq);
