...
public class StRvdmmyavS implements Serializable {
    private String stcd;
    ...
    private BigDecimal mymavz;

    private BigDecimal mymavq;
    ...
    public BigDecimal getMymavz() {
        return mymavz;
    }

    public void setMymavz(BigDecimal mymavz) {
        this.mymavz = mymavz;
    }

    public BigDecimal getMymavq() {
        return mymavq;
    }

    public void setMymavq(BigDecimal mymavq) {
        this.mymavq = mymavq;
    }
    ...
    public String toString() {
        ...
        sb.append(", mymavz=").append(mymavz);
        sb.append(", mymavq=").append(mymavq);
