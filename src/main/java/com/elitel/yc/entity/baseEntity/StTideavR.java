...
public class StTideavR implements Serializable {
    private String stcd;
    ...
    public BigDecimal getAvhtdz() {
        return avhtdz;
    }

    public void setAvhtdz(BigDecimal avhtdz) {
        this.avhtdz = avhtdz;
    }

    public BigDecimal getAvltdz() {
        return avltdz;
    }

    public void setAvltdz(BigDecimal avltdz) {
        this.avltdz = avltdz;
    }
    ...
    public String toString() {
        ...
        sb.append(", avhtdz=").append(avhtdz);
        sb.append(", avltdz=").append(avltdz);
